          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div
                  className="flex items-start p-4 rounded-lg border border-purple-500/20 bg-card/20 hover:bg-card/40 transition-colors duration-200"
                  style={{
                    boxShadow: "0 4px 20px -5px rgba(168, 85, 247, 0.25)",
                  }}
                >
                  <div
                    className="shrink-0 w-10 h-10 rounded-full bg-purple-600/30 flex items-center justify-center mr-4"
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-1 text-muted-foreground">
                      Start a pull request to contribute or open an issue if you
                      find a problem
                    </p>
                  </div>
                </div>
                ...
                <div
                  className="flex items-start p-4 rounded-lg border border-blue-500/20 bg-card/20 hover:bg-card/40 transition-colors duration-200"
                  style={{
                    boxShadow: "0 4px 20px -5px rgba(59, 130, 246, 0.25)",
                  }}
                >
                  <div
                    className="shrink-0 w-10 h-10 rounded-full bg-blue-600/30 flex items-center justify-center mr-4"
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-1 text-muted-foreground">
                      Receive developmental updates and participate in EECS Club
              ...
              <div className="w-full p-6 border border-secondary/20 rounded-lg bg-card/30 backdrop-blur-sm">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground mb-6">
                    The EECS Club (or the Electrical Engineering and Computer
                    Science Club) welcomes any and all students interested in
